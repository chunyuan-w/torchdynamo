...
at::Tensor call(at::Tensor arg0_1) {
    ...
    return buf3; }''' )
module = load_inline(name='inline_extension', cpp_sources=[kernel, wrapper], functions=['call'], extra_cflags=['-DCPU_CAPABILITY_AVX2 -march=native -O3 -ffast-math -fno-finite-math-only -fopenmp'])
call = module.call
